...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'barrs-barking-salon' ); ?></h1>
	</header>

	<div class="page-content">

        <p><?php esc_html_e( 'We couldn&rsquo;t find the content you&rsquo;re looking for. Maybe try one of the links below?', 'barrs-barking-salon' ); ?></p>
