<?php
/**
 * Barrs Barking Salon functions and definitions
 *
...
function plugin_dependency_check() {
	...
	$plugin_dependencies = [
		...
		"SimpLy Gallery Block" 		=> 'simply-gallery-block/plugin.php',
...
*/
function barrs_barking_salon_scripts() {
...
add_action( 'wp_enqueue_scripts', 'barrs_barking_salon_scripts' );
...
if ( ! function_exists( 'barrs_barking_salon_setup' ) ) :
	/**
	 ...
	 */
	function barrs_barking_salon_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Barrs Barking Salon, use a find and replace
		 * to change 'barrs-barking-salon' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'barrs-barking-salon', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'barrs-barking-salon' ),
                'menu-2' => esc_html__( 'Footer', 'barrs-barking-salon' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'barrs_barking_salon_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'barrs_barking_salon_setup' );
 ...
 */
function barrs_barking_salon_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'barrs_barking_salon_content_width', 640 );
}
add_action( 'after_setup_theme', 'barrs_barking_salon_content_width', 0 );
 ...
 */
function barrs_barking_salon_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'barrs-barking-salon' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'barrs-barking-salon' ),
...
add_action( 'widgets_init', 'barrs_barking_salon_widgets_init' );
